...
def main():
    ...
    ap.add_argument("--anims",
                    default="run:12:0.09,run_carry:12:0.09,idle:6,idle_carry:6,throw:8,catch:6,tackle:6:ground,kick:8:ground,recover:8:ground,block:6,celebrate:8,stance_ol:1:ground,stance_dl:1:ground,placekick:10:ground,holder:1:ground")
